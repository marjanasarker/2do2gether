...
messages_4=Messages(user_habit_id=4, sender_id=1, receiver_id=2, message_date='04-13-2021', message='Fantastic job on a great run!')
...
db.session.add_all([messages_1,messages_2,messages_3,messages_4])
db.session.commit()