...
habit_log_1=Habit_log(user_habit_id=1,journal_id=1,date_of='04-13-2021',log_in_time=1, progress=5)
habit_log_2=Habit_log(user_habit_id=2,journal_id=2,date_of='04-13-2021',log_in_time=1, progress=4)
habit_log_3=Habit_log(user_habit_id=3,journal_id=3,date_of='04-13-2021',log_in_time=1, progress=5)
habit_log_4=Habit_log(user_habit_id=4,journal_id=4,date_of='04-13-2021',log_in_time=0.5, progress=5)
